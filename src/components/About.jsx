...
function About() {
  return (
    <div name="/about" className='max-w-screen-2xl container mx-auto px-4  my-20'>
      <h1 className='mainH text-2xl md:text-3xl  mb-5 shadow-md p-4 rounded-lg bg-[darkcyan]'>About</h1>
      <p className='pera text-md md:text-lg'>I'm <span className='font-bold'>Satyam Kumar</span>, a passionate software developer skilled in 
...
<div className="educationContainer space-y-4">
      <h1 className='mainH subHdng text-lg md:text-2xl mt-20 shadow-md px-4 py-2 rounded-lg '>Education And Training</h1>
  <div className="educationSections flex flex-col md:flex-row space-y-6 md:space-x-6 md:space-y-0 md:p-4 p-1">
   ...
   <div className="experienceContainer space-y-4">
      <h1 className='mainH subHdng text-lg md:text-2xl mt-20 shadow-md px-4 py-2 rounded-lg
      
      '>Experience</h1>
      <div className="div md:p-4 p-1 overflow-hidden">


  <div className="experienceSections 
  flex flex-col md:flex-row space-y-6 md:space-x-6 md:space-y-0 md:p-4 p-1
  ">
