...
function About() {
  return (
    <div name="/about" className='max-w-screen-2xl container mx-auto px-4  my-20'>
      <h1 className='text-3xl font-bold mb-5 shadow-md p-4 rounded-lg bg-[darkcyan]'>About</h1>
      <p className='text-lg'>I'm <span className='font-bold'>Satyam Kumar</span>, a passionate software developer skilled in 
...
<div className="educationContainer space-y-4">
      <h1 className='text-2xl font-bold mt-20 shadow-md px-4 py-2 rounded-lg bg-[cadetblue]'>Education And Training</h1>
  <div className="educationSections flex space-x-6 p-4">
   ...
   <div className="experienceContainer space-y-4">
      <h1 className='text-2xl font-bold mt-20 shadow-md px-4 py-2 rounded-lg bg-[cadetblue]'>Experience</h1>
