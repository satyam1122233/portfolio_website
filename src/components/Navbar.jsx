...
{ id: 5, text: "Contacts", path: "/contacts" },
  ...
  return (
    <>
      <div className='max-w-screen-2xl container mx-auto px-4 md:px-20 h-16  fixed top-0 left-0 right-0 'style={{ backgroundColor:'black',boxShadow: '0 0px 12rem 0px white'}}>
...
{/* mobile nav bar */}
      {menuBtn && <div >
        <ul className='md:hidden flex flex-col items-center justify-center h-screen space-y-4  top-0 left-0 right-0'>
        {
                    navItems.map(({id,text,path})=>(
                      <li className='hover:scale-105 duration-200 cursor-pointer' key={id}>
